...
<body>
	<form id="inputForm" action="${ctx}/profile" method="post" class="form-horizontal">
		...
		<fieldset>
			<legend><small>Update User</small></legend>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="email" name="email" value="${user.email}" class="input-large email required"/>
				</div>
			</div>
			<div class="control-group">
				<label for="phone" class="control-label">Phone:</label>
				<div class="controls">
					<input type="text" id="phone" name="phone" value="${user.phone}" class="input-large required"/>
				</div>
			</div>
			<div class="control-group">
				<label for="status" class="control-label">Status:</label>
				<div class="controls">
					<input type="text" id="status" name="status" value="${user.status}" class="input-large required"/>
				</div>
			</div>
