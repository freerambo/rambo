 ...
 *******************************************************************************/
package com.eri.ict.web.project;
...
public class ProjectController {
	...
	static {
		...
		sortTypes.put("owner", "owner");
		sortTypes.put("oate", "date");
	}
...
//		Long userId = getCurrentUserId();
		...
		Page<Project> projects = projectService.getUserProject(searchParams, pageNumber, pageSize, sortType);
	...
	public String create(@Valid Project newProject, RedirectAttributes redirectAttributes) {
		...
		redirectAttributes.addFlashAttribute("message", "successfully created the project");
	...
	public String update(@Valid @ModelAttribute("project") Project project, RedirectAttributes redirectAttributes) {
		...
		redirectAttributes.addFlashAttribute("message", "successfully updated the project");
		return "redirect:/project/";
	}
	...
	public String delete(@PathVariable("id") Long id, RedirectAttributes redirectAttributes) {
		...
		redirectAttributes.addFlashAttribute("message", "successfully deleted the project");
		return "redirect:/project/";
	}
...
//		ShiroUser user = (ShiroUser) SecurityUtils.getSubject().getPrincipal();
		ShiroUser user = (ShiroUser) SecurityUtils.getSubject().getSession().getAttribute("principal");
		return user.id;
	}
}
