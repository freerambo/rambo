 ...
 * @version v 1.0 
 * Create:  12 Nov, 2014 10:08:33 pm
 */
public class PmWlgDayServiceTest {

	private static PmWlgDayService service;
	// recommend use in this way for slf4j 
	private static Logger log = LoggerFactory.getLogger(PmWlgDayServiceTest.class); // 日志打印
	...
	public static void main(String[] args) {
		...
		service = (PmWlgDayService) context.getBean("pmWlgDayService");
		test();
//		 testAddAll();
	}
...
//		service.createAllPmWlgDay(MeterConstants.METER_IDS_OF_SPMS, DateUtils.stringToDate("2014-11-06 13:00:00"), DateUtils.stringToDate("2014-11-10 13:00:00"));
		//		System.out.println(pwds.size());
//		
//		ListUtils.output(pwds);
		
//		service.createPmWlgDayMeters(MeterConstants.METER_IDS_OF_SPMS, DateUtils.stringToDate("2014-11-18 13:00:00"));	
	...
	static void testAddAll(){
		Date start = DateUtils.stringToDate("2014-11-11 13:00:00");
		Date now = new Date();
		while (start.before(now)){
			service.createPmWlgDayMeters(MeterConstants.METER_IDS_OF_SPMS, start);
