...
@Entity
@Table(name = "pm_wlg_week")
public class PmWlgWeek extends IdEntity implements java.io.Serializable {
	...
	public PmWlgWeek(Date dateTime, float value, double std, float max,
