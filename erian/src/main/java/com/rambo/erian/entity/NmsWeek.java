...
//@Entity
//@Table(name = "nms_week")
public class NmsWeek implements java.io.Serializable {
	...
	public NmsWeek(String dateTime, double value, String unit, double std, double max,
...
//	@GeneratedValue(strategy = GenerationType.AUTO)
	...
	public void setId(String meterId, String unit, String dateTime) {
		this.id = EncryptUtils.encryptMD5(meterId+"$"+unit+"$"+dateTime);
	}
