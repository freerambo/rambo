...
@Entity
@Table(name = "nms_week_result")
public class NmsWeekResult extends ExportModel implements java.io.Serializable {
	...
	public NmsWeekResult() {
	}

	public NmsWeekResult(String dateTime, double nanyang, double nieo,
			double spms) {
		super();
