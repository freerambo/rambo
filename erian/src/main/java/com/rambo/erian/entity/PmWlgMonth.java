...
@Entity
@Table(name = "pm_wlg_month")
public class PmWlgMonth extends IdEntity implements java.io.Serializable {
	...
	public PmWlgMonth(Date dateTime, float value, double std, float max,
