...
@Entity
@Table(name = "nms_kwh_imp_day")
public class NmsKwhImpDay implements java.io.Serializable {
	...
	public NmsKwhImpDay(String dateTime, double value, String unit, double std, double max,
		...
		this.unit = unit;
		this.id = EncryptUtils.encryptMD5(this.dateTime+this.meterId+this.unit);
	}
