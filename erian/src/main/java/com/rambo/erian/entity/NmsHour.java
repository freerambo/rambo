...
@Entity
@Table(name = "nms_hour_08")
public class NmsHour extends IdEntity implements java.io.Serializable {
	...
	public NmsHour(String dateTime, double value, String unit, double std, double max,
