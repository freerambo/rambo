...
/**
 * 
 * function description： PmWlgHour
 *
 * @author <a href="mailto:zhuyb@ntu.edu.sg">zhuyuanbo </a>
 * @version v 1.0 
 * Create:  5 Nov, 2014 2:44:37 pm
 */
@Entity
@Table(name = "pm_wlg_hour")
public class PmWlgHour extends IdEntity implements java.io.Serializable {
	...
	public PmWlgHour(Date dateTime, float value, double std, float max,
