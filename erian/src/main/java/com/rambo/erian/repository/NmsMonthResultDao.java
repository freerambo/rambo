 ...
 */
public interface NmsMonthResultDao extends PagingAndSortingRepository<NmsMonthResult, String>,
		JpaSpecificationExecutor<NmsWeekResult> {

	

	
	@Query(value=" from NmsMonthResult obj where obj.dateTime between ?1 and ?2 order by obj.dateTime")
