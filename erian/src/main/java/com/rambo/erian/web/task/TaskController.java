 ...
 *******************************************************************************/
package com.rambo.erian.web.task;
...
import com.rambo.erian.entity.Task;
...
import com.rambo.erian.service.task.TaskService;
...
/**
 * Controller for Task management, we utilize the Restful Apis:
 * 
...
public class TaskController {
	...
	private static Logger log = LoggerFactory.getLogger(TaskController.class); // 日志打印
...
//		 schedulerService.schedule("0/10 * * * * ?");
	...
	public String createForm(Model model) {
		...
		// PmWlgHour pmh =
		// pmWlgService.checkHourRawData(1,DateUtils.stringToDate("2014-10-29 12:00:00"),TimeConstants.TOTAL_OF_MINUTE);
		// pmWlgHourService.savePmWlgHour(pmh);
		long id = pmWlgHourService.createPmWlgHour(1,
				DateUtils.stringToDate("2014-10-30 12:00:00"),
				TimeConstants.TOTAL_OF_MINUTE);
		log.info("the insert Id is {}", id);
